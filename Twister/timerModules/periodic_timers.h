#ifndef _TIMERCREATION_H_
#define _TIMERCREATION_H_
...
static uint64_t prev_periodic_freq = get_current_timer_cycles();					//--! Alternate initialization is to create periodic_init func
static uint64_t curr_periodic_freq = 0;

int create_periodic_timer(static struct rte_timer * timer_name, uint32_t time_period, \
