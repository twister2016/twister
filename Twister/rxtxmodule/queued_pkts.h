...
uint64_t queue_time_limit = 15 * one_sec;		//--!TODO get the value from user
...
int add_pkt_to_queue(rte_mbuf * pkt, uint32_t dest_ip_of_pkt) {
	uint64_t curr_timer_cycle = get_current_timer_cycle();
