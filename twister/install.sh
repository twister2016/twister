...
cp $RTE_SDK/$RTE_TARGET/lib/* /home/twister/
echo 'install all twister headers'
mkdir -p /home/twister/include/.
cp  ./include/*.h /home/twister/include
cp $RTE_SDK/$RTE_TARGET/include/*.h /home/twister/
mkdir -p /home/twister/generic/.
mkdir -p /home/twister/exec-env/.
cp $RTE_SDK/$RTE_TARGET/include/generic/*.h /home/twister/generic/
cp $RTE_SDK/$RTE_TARGET/include/exec-env/*.h /home/twister/exec-env/
