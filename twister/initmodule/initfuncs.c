...
/* Ports*/
.n_ports = MAX_ETH_PORTS, .port_rx_ring_size = 128, .port_tx_ring_size = 512,

/* Rings */
.ring_rx_size = 128, .ring_tx_size = 128,

/* Buffer pool */
.pool_buffer_size = 2048 + sizeof(struct rte_mbuf) + RTE_PKTMBUF_HEADROOM, .pool_size = 32 * 1024,
        .pool_cache_size = 256,

        /* Burst sizes */
        .burst_size_rx_read = 32, .burst_size_rx_write = 32, .burst_size_worker_read = 32,
        .burst_size_worker_write = 32, .burst_size_tx_read = 32, .burst_size_tx_write = 32, };
